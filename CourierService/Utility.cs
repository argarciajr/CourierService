...
namespace CourierService
{
    public static class Utility
    {
        public static void ReadMe()
        {
            ...
            Console.WriteLine("* Weight            : Required. Accepts only numbers or decimal values more than zero i.e 10 or 10.5", Console.ForegroundColor);
            Console.WriteLine("* Distance          : Required. Accepts only numbers or decimal values more than zero i.e 10 or 20.5", Console.ForegroundColor);
